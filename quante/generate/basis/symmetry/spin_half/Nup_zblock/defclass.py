...
# @Last Modified time: 2024-09-30 14:56:35
...
class SpinHalfBasisNupZBlock(SpinHalfBasis):
    def __init__(self, L: int, Nup: int, zblock: int) -> None:
        ...
        from .defbasis import construct_Nup_zblock_basis
    ...
    def _Op(self, opnm, posn, coef, row_init, col_init, ME_init):
        from ..zblock.matrixele import single_sparse_matrix_element
    ...
    def _heimat(self, jxy, jz, cyclic=True):
        from ..zblock.matrixele import heisenberg_matrix_element
